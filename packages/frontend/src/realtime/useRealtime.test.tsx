...
describe('useRealtimeEvent', () => {
  ...
  it('should resubscribe when eventType changes', () => {
    ...
    // Should unsubscribe old subscription
    expect(unsubscribe).toHaveBeenCalled();
    // Should subscribe to new event type
  ...
  it('should not resubscribe when deps are stable', () => {
    ...
    // Since deps is empty [], the useCallback should return the same function
    // and useEffect should not resubscribe on rerender
